# Contributing to data.xaostech.io
...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/data.xaostech.io.git`
3. Add upstream remote: `git remote add upstream https://github.com/XAOSTECH/data.xaostech.io.git`
...
Feel free to open a [Discussion](https://github.com/XAOSTECH/data.xaostech.io/discussions) for questions or ideas.
